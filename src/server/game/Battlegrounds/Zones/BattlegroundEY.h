...
public:
    ...
    // Playerbots: node owner, the nested CapturePointInfo stays private.
    [[nodiscard]] TeamId GetCapturePointOwner(uint32 node) const { return _capturePointInfo[node]._ownerTeamId; }
