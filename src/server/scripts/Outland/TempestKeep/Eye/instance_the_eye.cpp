...
{
    { NPC_ALAR,             DATA_ALAR           },
    { NPC_VOID_REAVER,      DATA_REAVER         },
    { NPC_ASTROMANCER,      DATA_ASTROMANCER    },
...
{
    { GO_TK_ALAR_DOOR, DATA_ALAR, DOOR_TYPE_PASSAGE },
    { GO_TK_ALAR_ENTRY_DOOR, DATA_ALAR, DOOR_TYPE_ROOM },
    { GO_TK_REAVER_DOOR, DATA_REAVER, DOOR_TYPE_ROOM },
    { GO_TK_ASTRO_DOOR, DATA_ASTROMANCER, DOOR_TYPE_ROOM },
    { GO_TK_KAEL_ENTRY_DOOR_1, DATA_REAVER, DOOR_TYPE_PASSAGE },
    { GO_TK_KAEL_ENTRY_DOOR_2, DATA_REAVER, DOOR_TYPE_PASSAGE },
    { GO_TK_KAEL_ENTRY_DOOR_1, DATA_ASTROMANCER, DOOR_TYPE_PASSAGE },
    { GO_TK_KAEL_ENTRY_DOOR_2, DATA_ASTROMANCER, DOOR_TYPE_PASSAGE },
    { GO_KAEL_DOOR_1, DATA_KAELTHAS, DOOR_TYPE_ROOM },
    { GO_KAEL_DOOR_2, DATA_KAELTHAS, DOOR_TYPE_ROOM },
    { GO_TK_Raid_Door03, DATA_ASTROMANCER, DOOR_TYPE_PASSAGE },
    { GO_TK_Raid_Door04, DATA_REAVER, DOOR_TYPE_PASSAGE },
    { 0,              0,             DOOR_TYPE_ROOM }
};
